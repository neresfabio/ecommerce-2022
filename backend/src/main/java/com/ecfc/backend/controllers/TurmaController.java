...
public class TurmaController {
    @PostMapping
    public ResponseEntity<Object> save(@RequestBody TurmaDTO turmaDTO){
        return null;
    }
    @GetMapping("/{id}")
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> update(@PathVariable(value = "id") Long id, @RequestBody TurmaDTO turmaDTO){
        return null;
    }
    @DeleteMapping("/{id}")
